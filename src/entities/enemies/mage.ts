...
export class Mage extends Enemy {
    ...
    constructor(params: Params<EntityNode>, room: BattleRoom, sprite?: SpriteNode) {
        super(params, sprite ?? getSpriteById(2, levelToColor(room.level)), room);
    ...
    moveToPlayer() {
        const v = this.position.getDisplacementVector(Player.getInstance().position)
